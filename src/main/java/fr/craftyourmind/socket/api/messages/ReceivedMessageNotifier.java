 ...
 */
package fr.craftyourmind.socket.api.messages;
...
public class ReceivedMessageNotifier
{
  ...
  private final ConcurrentHashMap<String, CopyOnWriteArraySet<Consumer<fr.craftyourmind.socket.api.messages.ReceivedMessage>>> channelToConsumerSetMap;
  ...
  public void register(String channelName, Consumer<fr.craftyourmind.socket.api.messages.ReceivedMessage> consumer)
  {
    ...
    CopyOnWriteArraySet<Consumer<fr.craftyourmind.socket.api.messages.ReceivedMessage>> newSet = new CopyOnWriteArraySet<>(
      Collections.singleton(consumer));

    CopyOnWriteArraySet<Consumer<fr.craftyourmind.socket.api.messages.ReceivedMessage>> existingSet = channelToConsumerSetMap
  ...
  public void unregister(String channelName, Consumer<fr.craftyourmind.socket.api.messages.ReceivedMessage> consumer)
  {
    ExtraPreconditions.checkNotEmpty(channelName, "channelName");
    Preconditions.checkNotNull(consumer, "consumer");
