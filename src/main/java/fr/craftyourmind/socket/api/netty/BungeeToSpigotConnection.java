...
import fr.craftyourmind.socket.utils.LongIdCounterMap;
...
public class BungeeToSpigotConnection extends AbstractPacketHandler {
    ...
    private final TieIn bungeeTieIn;

    public BungeeToSpigotConnection(String serverName, Executor executor, ReceivedMessageNotifier receivedMessageNotifier, LongIdCounterMap<ExpirableConsumer<ResponseMessage>> waitingForResponse, BasicLogger basicLogger, TieIn bungeeTieIn) {
