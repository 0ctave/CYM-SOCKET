...
import fr.craftyourmind.socket.api.netty.packets.PacketToBungeeRequest.DestinationType;
...
public class SpigotToBungeeConnection extends AbstractPacketHandler {
    ...
    public void sendToServer(String channelName, byte[] messageBytes, String destServerName, Consumer<ResponseMessage> consumer, long timeoutInMillis) {
        ExtraPreconditions.checkNotEmpty(channelName, "channelName");
        Preconditions.checkNotNull(messageBytes, "messageBytes");
