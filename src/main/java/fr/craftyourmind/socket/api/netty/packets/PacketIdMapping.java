 ...
 */
package fr.craftyourmind.socket.api.netty.packets;
...
{
  private static final Map<Byte, Class<? extends fr.craftyourmind.socket.api.netty.packets.AbstractPacket>> idToPacket = new HashMap<>();
  private static final Map<Class<? extends fr.craftyourmind.socket.api.netty.packets.AbstractPacket>, Byte> packetToId = new HashMap<>();
  ...
  public static Class<? extends fr.craftyourmind.socket.api.netty.packets.AbstractPacket> idToPacket(byte id)
  {
    Class<? extends fr.craftyourmind.socket.api.netty.packets.AbstractPacket> clazz = idToPacket.get(id);
    if (clazz != null)
    {
      return clazz;
    }
  ...
  public static byte packetToId(Class<? extends fr.craftyourmind.socket.api.netty.packets.AbstractPacket> clazz)
  {
  ...
  public static boolean isIdForPacket(byte id, Class<? extends fr.craftyourmind.socket.api.netty.packets.AbstractPacket> clazz)
  {
