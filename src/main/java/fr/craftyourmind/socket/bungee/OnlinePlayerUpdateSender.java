...
public class OnlinePlayerUpdateSender implements Registerable {
    ...
    public OnlinePlayerUpdateSender(SocketBungee plugin, SocketApi api, long updatePeriodMillis) {
    ...
    public void register() {
        updateFuture = api.getScheduledExecutorService().scheduleAtFixedRate(this::sendPlayerUpdate, updatePeriodMillis, updatePeriodMillis, TimeUnit.MILLISECONDS);
    }
